...
import { crearExcelDb } from "../services/excelService.js";
import path from "path";



export const generarExcelDb = async (req, res) => {
    try {
      ...
      const workbook = await crearExcelDb(rows);
  
      // Escribir el archivo en un buffer
      const buffer = await workbook.xlsx.writeBuffer();
  
      // Establecer las cabeceras para la descarga
      res.setHeader('Content-Disposition', 'attachment; filename="Empleados_Data.xlsx"');
